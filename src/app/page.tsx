      ...
      <section className="bg-gradient-to-br from-blue-700 via-blue-800 to-slate-900 text-white py-16 px-4">
        <div className="max-w-6xl mx-auto text-center">
          <div className="inline-flex items-center gap-1.5 bg-yellow-400 text-yellow-900 text-xs font-bold px-3 py-1.5 rounded-full mb-5 uppercase tracking-wide">
            <svg className="w-3 h-3" width={12} height={12} fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="flex flex-wrap justify-center gap-4 text-sm">
            {[
              ...
              <span key={badge} className="flex items-center gap-1.5 bg-white/10 backdrop-blur-sm text-blue-100 px-3 py-1.5 rounded-full border border-white/20">
                <svg className="w-3.5 h-3.5 text-green-400 flex-shrink-0" width={14} height={14} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>
          ...
          {[
            {
              ...
              icon: (
                <svg className="w-6 h-6 text-slate-400" width={24} height={24} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              {
                icon: (
                  <svg className="w-8 h-8 text-blue-600" width={32} height={32} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                    <path strokeLinecap="round" strokeLinejoin="round" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                  </svg>
                ),
